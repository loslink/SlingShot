...
import com.loslink.slingshot.adapter.animation.AlphaInAnimation;
import com.loslink.slingshot.adapter.animation.BaseAnimation;
import com.loslink.slingshot.adapter.animation.ScaleInAnimation;
import com.loslink.slingshot.adapter.animation.SlideInBottomAnimation;
import com.loslink.slingshot.adapter.animation.SlideInLeftAnimation;
import com.loslink.slingshot.adapter.animation.SlideInRightAnimation;
...
public abstract class BaseQuickAdapter<T> extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    protected static final int NO_TOGGLE_VIEW = 0;
    ...
    protected void addLoadMore(RecyclerView.ViewHolder holder) {
